    ...
    <div className={style.container}>
      ...
      <div className={style.soulution_box}>
        ...
        <Link to="branding" className={style.box}>
            <div><img src={iconFour} alt="soulution" /></div>
            <div><h5>تصميم جرافيك</h5></div>
          </Link>

                    
          <Link to="marketing" className={style.box}>
            <div><img src={iconThree} alt="soulution" /></div>
            <div><h5>تسويق</h5></div>
          </Link>

                    
          <Link to="socialmedia" className={style.box}>
            <div><img src={iconTwo} alt="soulution" /></div>
            <div><h5>إدارة سوشيال ميديا</h5></div>
          </Link>
          
          <Link to="programing" className={style.box}>
            <div><img src={iconOne} alt="soulution" /></div>
            <div><h5>برمجة المواقع</h5></div>
          </Link>
